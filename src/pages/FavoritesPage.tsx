...
import { GUIDE_ENTRIES, SECT_PROFILES } from "../data/content";
...
const FavoritesPage = ({
  ...
  const hasFavorites = sects.length > 0 || guides.length > 0;
                ...
                {sects.map((profile) => (
                  ...
                  >
                    ...
                    <FavoriteButton
                      active
                      label={profile.id}
                      onClick={() => onToggleSect(profile.id)}
                    />
                  </article>
                ))}
              </div>
                ...
                {guides.map((entry) => (
                  ...
                  >
                    ...
                    <FavoriteButton
                      active
                      label={entry.title}
                      onClick={() => onToggleGuide(entry.id)}
                    />
                  </article>
                ))}
              </div>
